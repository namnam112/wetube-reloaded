...
exports.upload = exports.startGitHubLogin = exports.see = exports.remove = exports.postedit = exports.postLogin = exports.postJoin = exports.postChagePassword = exports.logout = exports.getedit = exports.getLogin = exports.getJoin = exports.getChagePassword = exports.finishGithubLogin = void 0;
...
var postJoin = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var _req$body, name, username, email, password, password2, location, file, pageTitle, exists;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _req$body = req.body, name = _req$body.name, username = _req$body.username, email = _req$body.email, password = _req$body.password, password2 = _req$body.password2, location = _req$body.location, file = _req$body.file;
            pageTitle = "Join";
...
var postedit = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
    var _req$session$user, _id, avataUrl, _req$body2, name, email, username, location, file, updateUser;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _req$session$user = req.session.user, _id = _req$session$user._id, avataUrl = _req$session$user.avataUrl, _req$body2 = req.body, name = _req$body2.name, email = _req$body2.email, username = _req$body2.username, location = _req$body2.location, file = req.file;
            _context2.next = 3;
          ...
          case 3:
            ...
            return _context2.abrupt("return", res.redirect("/users/edit"));
          case 6:
          case "end":
...
var postLogin = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req, res) {
    var _req$body3, username, password, user, pageTitle, ok;
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 6:
            return _context4.abrupt("return", res.render("users/profile", {
              pageTItle: user.name,
              user: user
            }));
          case 7:
...
var getChagePassword = function getChagePassword(req, res, next) {
...
var postChagePassword = /*#__PURE__*/function () {
  ...
  return function postChagePassword(_x11, _x12, _x13) {
